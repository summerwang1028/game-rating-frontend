                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 4;
                                return _api2.default.post('/comments', comment);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', {
                        ...
                        onChange: function onChange(e) {
                            _this2.setState({ context: e.target.value });
                        }
                    })
                ),
                _react2.default.createElement('input', { type: 'submit', value: 'Post new comment' })
            );
        }
    }]);
...
var Comments = function (_React$Component2) {
    ...
    function Comments(props) {
        ...
        _this3.fetchComments = _this3.fetchComments.bind(_this3);
        _this3.renderComments = _this3.renderComments.bind(_this3);
        _this3.deleteComment = _this3.deleteComment.bind(_this3);
        _this3.state = {
            comments: []
        };
        return _this3;
    ...
    _createClass(Comments, [{
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.next = 3;
                                return _api2.default.get('comments/game/' + game._id);
        ...
        key: 'deleteComment',
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(commentId) {
                return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return _api2.default.delete('comments/' + commentId);
        ...
        value: function renderComments() {
            ...
            return this.state.comments.map(function (comment, ii) {
                return _react2.default.createElement(
                    'div',
                    { key: ii },
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { onClick: function onClick(e) {
                                _this4.deleteComment(comment._id);
                            } },
                        'delete'
                    ),
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(CommentForm, { game: this.props.game }),
                _react2.default.createElement('hr', null),
                this.renderComments()
            );
        }
...
exports.default = (0, _reactStatic.withRouteData)(function (_ref4) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('br', null),
        _react2.default.createElement(Comments, { game: game })
    );
});
...
var GameForm = function (_React$Component) {
    ...
    function GameForm(props) {
        ...
        var _this = _possibleConstructorReturn(this, (GameForm.__proto__ || Object.getPrototypeOf(GameForm)).call(this, props));
    ...
    _createClass(GameForm, [{
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _api2.default.post('/games', this.state);
                                location.reload();
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'submit', value: 'Create new Game' })
            );
        }
    }]);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/ChenxiYuan/Project/game-rating-website/client/dist/react-static-routes.js',
  load: function load() {
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/ChenxiYuan/Project/game-rating-website/client/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 7)), (0, _importCss3.default)('src/containers/Game', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/GameList',
  file: '/Users/ChenxiYuan/Project/game-rating-website/client/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 10)), (0, _importCss3.default)('src/containers/GameList', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/GameList');
  },
  resolve: function resolve() {
    return /*require.resolve*/(10);
  },
  chunkName: function chunkName() {
    return 'src/containers/GameList';
  }
}), universalOptions);
